...
major challenge.  Heterogeneity amongst buildings is widespread and that diversity is reflected
...
Although this architecture provides some of the necessary capabilities for easing generalizability across
...
to the number of points that need to be used by the process. Running the same software across 
...
There has been some recent work in this area.
...
we learn in each building to improve the model, increase coverage, and maximize performan
