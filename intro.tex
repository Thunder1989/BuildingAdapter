...
Buildings consume a large fraction of the energy produced in the US and much of it is wasted.
Fortunately many buildings are sites of very large sensor deployments, allowing us, in principle, to
understand the dynamics of each building and optimize its performance.
...
into an analytical pipeline, such as overall building energy performance  or
comfort-assessment and control analytics.
