...
Our newly proposed algorithm exploits the insight that the sensor stream data and the names of sensors characterize different properties of a sensor point, therefore features extracted from both the data and the point names are employed. 
...
Our transfer learning based approach exploits two common observations of the sensor points in a building - the actual data readings and the text string-based point names, both of which play an important role for differentiating sensor types.
