...
To minimize this variance we combine the knowledge in across base models.  % rather than only using any particular model, to more effectively transfer the knowledge to the new building. 
