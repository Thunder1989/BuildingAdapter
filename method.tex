...
To combine the knowledge across base models,  % rather than only using any particular model, to more effectively transfer the knowledge to the new building. 
