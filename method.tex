...
To encapsulate the information from one labeled building and transfer it across buildings, we construct a set of supervised classifiers 
...
\subsubsection{Locally Weighted Ensemble}
