...
From the last column in Table~\ref{table:sdh} and~\ref{table:rice}, we see that both building achieve a high accuracy of 91\% and 92\% on SDH and Rice Hall respectively, for the leave-one-out (LOO) cross validation.
